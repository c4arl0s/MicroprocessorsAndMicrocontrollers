...
;########## CONFIGURACION DE OSCILADOR Y COMPARADORES APAGADOS #######################
...
INIT		BANCO1
		...
		MOVLW		H'00'
		MOVWF		TRISB			;salidas		0 - salida; 1 - entrada
...
;##############CONFIGURANDO EL MODULO PWM E INICIALIZANDO CICLO DE TRABAJO A 0%  #######################
		...
		BANCO0
		MOVLW		H'00'			;cargamos los 8 bits mas significativos del ciclo de trabajo
...
;#######################################################################
		...
		MOVLW		H'FF'
		MOVWF		PORTB			; inicializo con el puertoB encendido		
